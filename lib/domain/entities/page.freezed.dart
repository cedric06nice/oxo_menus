...
mixin _$Page {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, menuId, name, index, dateCreated, dateUpdated);
...
extension PagePatterns on Page {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String menuId, String name, int index,
    ...
    switch (_that) {
      case _Page() when $default != null:
        return $default(_that.id, _that.menuId, _that.name, _that.index,
