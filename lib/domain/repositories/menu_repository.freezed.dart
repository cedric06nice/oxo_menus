...
mixin _$CreateMenuInput {
 ...
 String get name; String get version; Status? get status; StyleConfig? get styleConfig; int? get sizeId; String? get area; MenuDisplayOptions? get displayOptions;
...
@override
int get hashCode => Object.hash(runtimeType,name,version,status,styleConfig,sizeId,area,displayOptions);

@override
String toString() {
  return 'CreateMenuInput(name: $name, version: $version, status: $status, styleConfig: $styleConfig, sizeId: $sizeId, area: $area, displayOptions: $displayOptions)';
}
...
@useResult
$Res call({
 String name, String version, Status? status, StyleConfig? styleConfig, int? sizeId, String? area, MenuDisplayOptions? displayOptions
});
...
/// Create a copy of CreateMenuInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? version = null,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? area = freezed,Object? displayOptions = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  String? area,  MenuDisplayOptions? displayOptions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateMenuInput() when $default != null:
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.area,_that.displayOptions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  String? area,  MenuDisplayOptions? displayOptions)  $default,) {final _that = this;
switch (_that) {
case _CreateMenuInput():
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.area,_that.displayOptions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  String? area,  MenuDisplayOptions? displayOptions)?  $default,) {final _that = this;
switch (_that) {
case _CreateMenuInput() when $default != null:
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.area,_that.displayOptions);case _:
  return null;
...
class _CreateMenuInput extends CreateMenuInput {
  const _CreateMenuInput({required this.name, required this.version, this.status, this.styleConfig, this.sizeId, this.area, this.displayOptions}): super._();
...
/// Create a copy of CreateMenuInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? version = null,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? area = freezed,Object? displayOptions = freezed,}) {
...
mixin _$UpdateMenuInput {
 ...
 int get id; String? get name; String? get version; Status? get status; StyleConfig? get styleConfig; PageSize? get pageSize; String? get area; MenuDisplayOptions? get displayOptions;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,version,status,styleConfig,pageSize,area,displayOptions);

@override
String toString() {
  return 'UpdateMenuInput(id: $id, name: $name, version: $version, status: $status, styleConfig: $styleConfig, pageSize: $pageSize, area: $area, displayOptions: $displayOptions)';
}
...
@useResult
$Res call({
 int id, String? name, String? version, Status? status, StyleConfig? styleConfig, PageSize? pageSize, String? area, MenuDisplayOptions? displayOptions
});
...
/// Create a copy of UpdateMenuInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? version = freezed,Object? status = freezed,Object? styleConfig = freezed,Object? pageSize = freezed,Object? area = freezed,Object? displayOptions = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  PageSize? pageSize,  String? area,  MenuDisplayOptions? displayOptions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateMenuInput() when $default != null:
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.pageSize,_that.area,_that.displayOptions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  PageSize? pageSize,  String? area,  MenuDisplayOptions? displayOptions)  $default,) {final _that = this;
switch (_that) {
case _UpdateMenuInput():
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.pageSize,_that.area,_that.displayOptions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  PageSize? pageSize,  String? area,  MenuDisplayOptions? displayOptions)?  $default,) {final _that = this;
switch (_that) {
case _UpdateMenuInput() when $default != null:
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.pageSize,_that.area,_that.displayOptions);case _:
  return null;
...
class _UpdateMenuInput extends UpdateMenuInput {
  const _UpdateMenuInput({required this.id, this.name, this.version, this.status, this.styleConfig, this.pageSize, this.area, this.displayOptions}): super._();
...
/// Create a copy of UpdateMenuInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? version = freezed,Object? status = freezed,Object? styleConfig = freezed,Object? pageSize = freezed,Object? area = freezed,Object? displayOptions = freezed,}) {
