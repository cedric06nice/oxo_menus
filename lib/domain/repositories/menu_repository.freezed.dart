...
mixin _$CreateMenuInput {
 ...
 String get name; String get version; Status? get status; StyleConfig? get styleConfig; int? get sizeId; int? get areaId; MenuDisplayOptions? get displayOptions; List<String>? get allowedWidgetTypes;
...
@override
int get hashCode => Object.hash(runtimeType,name,version,status,styleConfig,sizeId,areaId,displayOptions,const DeepCollectionEquality().hash(allowedWidgetTypes));

@override
String toString() {
  return 'CreateMenuInput(name: $name, version: $version, status: $status, styleConfig: $styleConfig, sizeId: $sizeId, areaId: $areaId, displayOptions: $displayOptions, allowedWidgetTypes: $allowedWidgetTypes)';
}
...
@useResult
$Res call({
 String name, String version, Status? status, StyleConfig? styleConfig, int? sizeId, int? areaId, MenuDisplayOptions? displayOptions, List<String>? allowedWidgetTypes
});
...
/// Create a copy of CreateMenuInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? version = null,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? areaId = freezed,Object? displayOptions = freezed,Object? allowedWidgetTypes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateMenuInput() when $default != null:
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)  $default,) {final _that = this;
switch (_that) {
case _CreateMenuInput():
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)?  $default,) {final _that = this;
switch (_that) {
case _CreateMenuInput() when $default != null:
return $default(_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  return null;
...
class _CreateMenuInput extends CreateMenuInput {
  const _CreateMenuInput({required this.name, required this.version, this.status, this.styleConfig, this.sizeId, this.areaId, this.displayOptions, final  List<String>? allowedWidgetTypes}): _allowedWidgetTypes = allowedWidgetTypes,super._();
...
@override List<String>? get allowedWidgetTypes {
  final value = _allowedWidgetTypes;
...
@override
int get hashCode => Object.hash(runtimeType,name,version,status,styleConfig,sizeId,areaId,displayOptions,const DeepCollectionEquality().hash(_allowedWidgetTypes));
...
/// Create a copy of CreateMenuInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? version = null,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? areaId = freezed,Object? displayOptions = freezed,Object? allowedWidgetTypes = freezed,}) {
...
mixin _$UpdateMenuInput {
 ...
 int get id; String? get name; String? get version; Status? get status; StyleConfig? get styleConfig; int? get sizeId; int? get areaId; MenuDisplayOptions? get displayOptions; List<String>? get allowedWidgetTypes;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,version,status,styleConfig,sizeId,areaId,displayOptions,const DeepCollectionEquality().hash(allowedWidgetTypes));

@override
String toString() {
  return 'UpdateMenuInput(id: $id, name: $name, version: $version, status: $status, styleConfig: $styleConfig, sizeId: $sizeId, areaId: $areaId, displayOptions: $displayOptions, allowedWidgetTypes: $allowedWidgetTypes)';
}
...
@useResult
$Res call({
 int id, String? name, String? version, Status? status, StyleConfig? styleConfig, int? sizeId, int? areaId, MenuDisplayOptions? displayOptions, List<String>? allowedWidgetTypes
});
...
/// Create a copy of UpdateMenuInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? version = freezed,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? areaId = freezed,Object? displayOptions = freezed,Object? allowedWidgetTypes = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateMenuInput() when $default != null:
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)  $default,) {final _that = this;
switch (_that) {
case _UpdateMenuInput():
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? name,  String? version,  Status? status,  StyleConfig? styleConfig,  int? sizeId,  int? areaId,  MenuDisplayOptions? displayOptions,  List<String>? allowedWidgetTypes)?  $default,) {final _that = this;
switch (_that) {
case _UpdateMenuInput() when $default != null:
return $default(_that.id,_that.name,_that.version,_that.status,_that.styleConfig,_that.sizeId,_that.areaId,_that.displayOptions,_that.allowedWidgetTypes);case _:
  return null;
...
class _UpdateMenuInput extends UpdateMenuInput {
  const _UpdateMenuInput({required this.id, this.name, this.version, this.status, this.styleConfig, this.sizeId, this.areaId, this.displayOptions, final  List<String>? allowedWidgetTypes}): _allowedWidgetTypes = allowedWidgetTypes,super._();
...
@override
int get hashCode => Object.hash(runtimeType,id,name,version,status,styleConfig,sizeId,areaId,displayOptions,const DeepCollectionEquality().hash(_allowedWidgetTypes));
...
/// Create a copy of UpdateMenuInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? version = freezed,Object? status = freezed,Object? styleConfig = freezed,Object? sizeId = freezed,Object? areaId = freezed,Object? displayOptions = freezed,Object? allowedWidgetTypes = freezed,}) {
