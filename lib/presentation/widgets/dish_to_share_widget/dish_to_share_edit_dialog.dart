...
/// Dialog for editing dish-to-share properties
class DishToShareEditDialog extends StatefulWidget {
  final DishToShareProps props;
  final void Function(DishToShareProps) onSave;

  const DishToShareEditDialog({
    super.key,
    required this.props,
  ...
  @override
  State<DishToShareEditDialog> createState() => _DishToShareEditDialogState();
}

class _DishToShareEditDialogState extends State<DishToShareEditDialog> {
  ...
  void _handleSave() {
    final updatedProps = DishToShareProps(
