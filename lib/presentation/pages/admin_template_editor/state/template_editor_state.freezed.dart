...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TemplateEditorState&&(identical(other.isSaving, isSaving) || other.isSaving == isSaving));
}
...
@override
String toString() {
  return 'TemplateEditorState(isSaving: $isSaving)';
}
...
/// Create a copy of TemplateEditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isSaving = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isSaving)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TemplateEditorState() when $default != null:
return $default(_that.isSaving);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isSaving)  $default,) {final _that = this;
switch (_that) {
case _TemplateEditorState():
return $default(_that.isSaving);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isSaving)?  $default,) {final _that = this;
switch (_that) {
case _TemplateEditorState() when $default != null:
return $default(_that.isSaving);case _:
  return null;
...
class _TemplateEditorState implements TemplateEditorState {
  const _TemplateEditorState({this.isSaving = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TemplateEditorState&&(identical(other.isSaving, isSaving) || other.isSaving == isSaving));
}
...
/// Create a copy of TemplateEditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isSaving = null,}) {
