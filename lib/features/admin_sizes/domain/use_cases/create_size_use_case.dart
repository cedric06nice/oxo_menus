...
/// Creates a new page size on behalf of the admin sizes view model.
///
/// Authorisation rule:
/// - **Admin** — forwards the request to the repository.
/// - **Non-admin / anonymous** — never reaches the repository; returns
///   [UnauthorizedError].
class CreateSizeUseCase extends UseCase<CreateSizeInput, Size> {
  CreateSizeUseCase({
  ...
  Future<Result<Size, DomainError>> execute(CreateSizeInput input) async {
    ...
    return _sizeRepository.create(input);
  }
}
