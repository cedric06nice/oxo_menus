...
///
/// `MainRouter` implements this; the [AdminSizesViewModel] depends on it so
/// the view model never sees `BuildContext` or any concrete router. The
/// admin-sizes screen is a leaf — its only navigation is "back" — so the
/// contract intentionally exposes nothing more.
