...
import 'package:oxo_menus/features/menu/presentation/widgets/editor/editor_drop_zone.dart';
import 'package:oxo_menus/features/widget_system/presentation/widget_system/presentable_widget_registry.dart';

/// Reusable column card for both AdminTemplateEditorScreen and MenuEditorScreen.
///
/// Renders a column with drop zones, widgets, and empty states.
/// Per-screen widget rendering is delegated to [widgetItemBuilder].
