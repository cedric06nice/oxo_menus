...
void main() {
  group('FakeWidgetRepository', () {
    ...
    group('unconfigured methods throw StateError', () {
      ...
      test('should throw StateError when moveTo is called without configuration',
          () async {
        // Act / Assert
        await expectLater(
          fake.moveTo(1, 2, 0),
    ...
    group('preset responses', () {
      ...
      test('should return configured success result from getAllForColumn()',
          () async {
        // Arrange
        final widgets = [
      ...
      test('should complete successfully from moveTo() when configured',
          () async {
        // Arrange
      ...
      test('should complete successfully from lockForEditing() when configured',
          () async {
        // Arrange
        ...
        // Act / Assert
        await expectLater(
          fake.lockForEditing(1, 'user-uuid-123'),
          completes,
        );
      });
    ...
    group('call recording', () {
      test(
        ...
        expect(fake.createCalls.first.input.props['name'], equals('Chardonnay'));
