...
Page _testPage({int id = 1, int menuId = 10}) => Page(
      id: id,
      menuId: menuId,
      name: 'Page $id',
      index: id - 1,
...
void main() {
  group('FakePageRepository', () {
    ...
    group('create', () {
      ...
      test(
        'should return new page when configured with success',
        () async {
    ...
    group('getAllForMenu', () {
      ...
      test(
        'should return page list when configured with success',
        () async {
      ...
      test(
        'should record getAllForMenu call with correct menuId',
        () async {
          repo.whenGetAllForMenu(success([]));
    ...
    group('getById', () {
      ...
      test(
        'should return page when configured with success',
        () async {
          final page = _testPage();
    ...
    group('update', () {
      ...
      test(
        'should return updated page when configured with success',
        () async {
          final page = _testPage();
