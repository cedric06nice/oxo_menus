...
void main() {
  group('FakeFileRepository', () {
    ...
    group('upload', () {
      ...
      test(
        'should return file ID when configured with success',
        () async {
          ...
          expect(
            result,
            equals(Success<String, DomainError>('file-id-123')),
          );
        },
      );

      test(
        'should return failure when configured with error',
        () async {
    ...
    group('replace', () {
      ...
      test(
        'should return same file ID when configured with success',
        () async {
      ...
      test(
        'should record replace call with correct arguments',
        () async {
    ...
    group('listImageFiles', () {
      ...
      test(
        'should record listImageFiles call',
        () async {
          repo.whenListImageFiles(success([]));
    ...
    group('downloadFile', () {
      ...
      test(
        'should return file bytes when configured with success',
        () async {
      ...
      test(
        'should record downloadFile call with correct fileId',
        () async {
