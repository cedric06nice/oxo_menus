...
void main() {
  ...
  group('CompactEdgeInsetsEditor', () {
    ...
    testWidgets('detects mode from initial values using EdgeInsetsEditor.detectMode',
        (tester) async {
      // All equal → All mode
    ...
    testWidgets('re-detects mode when new prop values have different symmetry',
        (tester) async {
