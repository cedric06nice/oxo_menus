...
void main() {
  group('WidgetTypeConfig', () {
    group('construction', () {
      test('should create config with correct type when only type is provided', () {
        // Arrange & Act
      ...
      test('should default alignment to WidgetAlignment.start when not specified', () {
        // Arrange & Act
        const config = WidgetTypeConfig(type: 'dish');
      ...
      test('should store the specified alignment when alignment is provided', () {
        // Arrange & Act
        const config = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.justified);
      ...
      test('should store alignment center when alignment is center', () {
        // Arrange & Act
        const config = WidgetTypeConfig(type: 'wine', alignment: WidgetAlignment.center);
      ...
      test('should store alignment end when alignment is end', () {
        // Arrange & Act
        const config = WidgetTypeConfig(type: 'wine', alignment: WidgetAlignment.end);

        // Assert
        expect(config.alignment, WidgetAlignment.end);
      });

      test('should store enabled false when enabled is explicitly set to false', () {
        // Arrange & Act
    ...
    group('equality', () {
      test('should be equal when all fields have the same values', () {
        // Arrange
        const a = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.start, enabled: true);
        const b = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.start, enabled: true);
      ...
      test('should not be equal when alignment differs', () {
        // Arrange
        const a = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.start);
        const b = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.center);
    ...
    group('copyWith', () {
      test('should update alignment when copyWith is called with a new alignment', () {
        // Arrange
        const config = WidgetTypeConfig(type: 'dish', alignment: WidgetAlignment.start);
      ...
      test('should update enabled to false when copyWith is called with false', () {
        // Arrange
    ...
    group('JSON serialization', () {
      ...
      test('should deserialize WidgetTypeConfig from JSON with correct field values', () {
        // Arrange
      ...
      test('should default alignment to start when alignment is absent from JSON', () {
        // Arrange
      ...
      test('should default enabled to true when enabled is absent from JSON', () {
        // Arrange
        final json = {'type': 'dish'};
      ...
      test('should round-trip center alignment through JSON', () {
        // Arrange
        const original = WidgetTypeConfig(type: 'wine', alignment: WidgetAlignment.center);
      ...
      test('should round-trip end alignment through JSON', () {
        // Arrange
        const original = WidgetTypeConfig(type: 'wine', alignment: WidgetAlignment.end);
