...
void main() {
  group('LoadMenuForEditorUseCase — authenticated', () {
    test('returns a flat tree split by header/footer/content pages', () async {
      ...
      final useCase = LoadMenuForEditorUseCase(
        authGateway: gateway,
  ...
  group('LoadMenuForEditorUseCase — anonymous', () {
    test(
      'returns UnauthorizedError without touching the repositories',
      () async {
