...
void main() {
  group('MenuPresence', () {
    group('construction', () {
      test(
        'should create presence with correct required fields when all required fields are provided',
        () {
          // Arrange
    ...
    group('copyWith', () {
      test(
        'should update lastSeen when copyWith is called with a new lastSeen value',
        () {
          // Arrange
          final presence = MenuPresence(
            id: 1,
          ...
          // Act
          final updated = presence.copyWith(
            lastSeen: DateTime(2025, 1, 15, 11, 0),
          );
      ...
      test(
        'should update userName when copyWith is called with a new userName',
        () {
          // Arrange
          final presence = MenuPresence(
            id: 1,
      ...
      test(
        'should update userAvatar when copyWith is called with a new userAvatar',
        () {
          // Arrange
          final presence = MenuPresence(
            id: 1,
      ...
      test(
        'should preserve unchanged fields when only lastSeen is updated',
        () {
          // Arrange
          final presence = MenuPresence(
            id: 5,
